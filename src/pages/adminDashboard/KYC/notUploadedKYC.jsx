...
export const NotUploadedKYC = () =>{
  ...
  useEffect(() =>{
    if(!notUploadKYCSearch){
      NotUploadKYCFunction()
    }else if(notUploadKYCSearch){
      filterNotUploadedKYC()
    }
  }, [notUploadKYCSearch])
  ...
  const pageCount = Math.ceil(notUploadKYCData.length / dataPerPage)

  const currentData = notUploadKYCData.slice(
        ...
        <div className="container-xl">
          <section className='py-4'>
            <div className="d-flex justify-content-between align-items-center height-100">
              <div>
                <div>
                  <p className='dashboard-header'>KYCs Not Uploaded</p>
                  <p className='light-text'>Total {notUploadKYCsCount} KYCs not uploaded yet</p>
                </div>
              </div>
          ...
          <section className='py-5 mt-3'>
            <div className='d-flex justify-content-end'>
              <div className='pb-3'>
                <input type="text" className="p-2 dashboard-search-input" placeholder="search..." value={notUploadKYCSearch} onChange={(e) => setNotUploadKYCSearch(e.target.value)} />
              </div>
            </div>
